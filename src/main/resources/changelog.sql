...
CREATE TABLE "user_table" ("id" INTEGER GENERATED BY DEFAULT AS IDENTITY NOT NULL, "email" VARCHAR(500), "password" VARCHAR(500), "role" VARCHAR(500), CONSTRAINT "user_table_pkey" PRIMARY KEY ("id"));

-- changeset AYUSH:1737108894547-2
CREATE TABLE "employee" ("id" INTEGER NOT NULL, "salary" FLOAT8 NOT NULL, "aadhar_card_no" BIGINT NOT NULL, "contact_number" BIGINT NOT NULL, "name" VARCHAR(500), "qualification" VARCHAR(500), CONSTRAINT "employee_pkey" PRIMARY KEY ("id"));
